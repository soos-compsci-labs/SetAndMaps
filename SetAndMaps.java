...
public class SetAndMaps {
   ...
   public static Set union(Set s1, Set s2) {
      ...
      Iterator it = s1.iterator(); // create an iterator for s1
      while (it.hasNext()) ans.add(it.next()); // add all elements from s1 to ans
      it = s2.iterator(); // create an iterator for s2
      while (it.hasNext()) ans.add(it.next()); // add all elements from s2 to ans
      return ans;
   }
   ...
   public static Set intersection(Set s1, Set s2) {
      ...
      //***COMPLETE THIS METHOD***
        ...
        while (it.hasNext()) {
            Object o = it.next();
            if (s2.contains(o)) ans.add(o); // if s2 contains the element, add it to ans
        }
      return ans;
   }
...

   {
      ...
      //***COMPLETE THIS METHOD***
        ...
        while (it.hasNext()) {
            Object o = it.next();
            if (!s2.contains(o)) ans.add(o); // if s2 does not contain the element, add it to ans
        }
      return ans;
   }
   ...
   public static Set exclusion(Set s1, Set s2) {
      ...
      //***COMPLETE THIS METHOD***
        ...
        while (it.hasNext()) {
            Object o = it.next();
            if (!s1.contains(o)) ans.add(o); // if s1 does not contain the element, add it to ans
        }
      return ans;
   }
   ...
   public static Map flip(Map < String, String > m) {
      ...
      //***COMPLETE THIS METHOD***
        ...
        while (it.hasNext()) {
            String key = (String) it.next(); // get the key & value
            String value = m.get(key);
            if (ans.containsKey(value)) {
                ans.get(value).add(key); // if the value is already in the map, add the key to the arraylist
            } else { // if the value is not in the map, create a new arraylist and add the key to it
